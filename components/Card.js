  ...
  return(
      ...
      shadow-lg hover:bg-black hover:text-white duration-300">
            ...
            <div className={"flex justify-center"}>
              <img alt={!heading ? "Character Portrait" : `${heading} portrait`} className="w-11 h-11 rounded-full mr-4 shadow-lg border-2 border-black" src={!img ? '/rickandmorty.jpg' : img}/>
            </div>
          </div>
        </a>
      </Link>
